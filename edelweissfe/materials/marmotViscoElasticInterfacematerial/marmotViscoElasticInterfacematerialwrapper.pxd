...
cdef extern from "Marmot/LinearViscoElasticInterface.h" namespace "Marmot::Materials" nogil:
    cdef cppclass LinearViscoElasticInterface nogil:
    
        LinearViscoElasticInterface( const double* materialProperties, int nMaterialProperties, int materialNumber ) except+
